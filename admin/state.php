                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit-state.php?id=<?php echo $row['id']; ?>" class="text-decoration-none"><i class="icon-edit"></i></a>
                        <a href="state.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="text-decoration-none"><i class="icon-remove-sign"></i></a>
                      </td>
                    </tr>
                    <?php $cnt = $cnt + 1; } ?>
