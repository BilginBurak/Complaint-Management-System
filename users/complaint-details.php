  ...
  <section id="main-content">
    <section class="wrapper site-min-height">
      ...
      while($row=mysqli_fetch_array($query)) { ?>
        <div class="row mt">
          <div class="col-sm-2 col-sm-2 control-label"><b>Complaint Number :</b></div>
          <div class="col-sm-4">
            <p><?php echo htmlentities($row['complaintNumber']);?></p>
          </div>
          <div class="col-sm-2 col-sm-2 control-label"><b>Reg. Date :</b></div>
          <div class="col-sm-4">
        ...
        <div class="row mt">
          <div class="col-sm-2 col-sm-2 control-label"><b>Category :</b></div>
          <div class="col-sm-4">
            <p><?php echo htmlentities($row['catname']);?></p>
          </div>
          <div class="col-sm-2 col-sm-2 control-label"><b>Sub Category :</b></div>
          <div class="col-sm-4">
        ...
        <div class="row mt">
          <div class="col-sm-2 col-sm-2 control-label"><b>Complaint Type :</b></div>
          <div class="col-sm-4">
            <p><?php echo htmlentities($row['complaintType']);?></p>
          </div>
          <div class="col-sm-2 col-sm-2 control-label"><b>State :</b></div>
          <div class="col-sm-4">
        ...
        <div class="row mt">
          <div class="col-sm-2 col-sm-2 control-label"><b>Nature of Complaint :</b></div>
          <div class="col-sm-4">
            <p><?php echo htmlentities($row['noc']);?></p>
          </div>
          <div class="col-sm-2 col-sm-2 control-label"><b>File :</b></div>
          <div class="col-sm-4">
            <p><?php 
