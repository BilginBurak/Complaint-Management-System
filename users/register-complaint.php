...
if (strlen($_SESSION['login']) == 0) {
  ...
  <section id="container" class="mt-0">
        ...
        <div class="col-lg-12">
          <div class="card" style="height:auto;">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" name="complaint" enctype="multipart/form-data">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label for="noc" class="form-label">Nature of Complaint</label>
                  <input type="text" name="noc" class="form-control" required>
                </div>
                <div class="col-md-6">
                  <label for="complaindetails" class="form-label">Complaint Details (max 2000 words)</label>
                  <textarea name="complaindetails" class="form-control" rows="10" maxlength="2000" required></textarea>
                </div>
                <div class="col-md-6">
                  <label for="compfile" class="form-label">Complaint Related Doc (if any)</label>
